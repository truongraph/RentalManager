...
class BillTab(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        ctk.CTkLabel(form, text="Kỳ thanh toán *", font=("Inter", 14, "bold")).grid(row=0, column=1, sticky="w", pady=(0, 5), padx=(30, 0))
        ...
        self.entry_elec_new = ctk.CTkEntry(form, height=40, corner_radius=7, font=("Inter", 15), placeholder_text="Nhập số mới")
        ...
        self.entry_water_new = ctk.CTkEntry(form, height=40, corner_radius=7, font=("Inter", 15), placeholder_text="Nhập số mới")
        ...
        self.entry_elec_prev = ctk.CTkEntry(form, height=40, corner_radius=7, font=("Inter", 15),
                                            state="readonly", fg_color="#f8fafc", text_color="#dc2626",
        ...
        self.entry_water_prev = ctk.CTkEntry(form, height=40, corner_radius=7, font=("Inter", 15),
                                             state="readonly", fg_color="#f8fafc", text_color="#dc2626",
                                             placeholder_text="Tự động")
        self.entry_water_prev.grid(row=3, column=1, sticky="ew", pady=(0, 20), padx=(30, 0))

        ctk.CTkLabel(form, text="Tiền phòng", font=("Inter", 14, "bold")).grid(row=2, column=2, sticky="w", pady=(20, 5), padx=(30, 0))
        self.entry_room_rent = ctk.CTkEntry(form, height=40, corner_radius=7, font=("Inter", 15),
                                            state="readonly", fg_color="#f0fdf4", text_color="#16a34a",
                                            placeholder_text="Tự động")
        self.entry_room_rent.grid(row=3, column=2, sticky="ew", pady=(0, 20), padx=(30, 0))
        ...
        self.entry_other_fee.grid(row=3, column=3, sticky="ew", pady=(0, 20), padx=(30, 0))
        ...
        ctk.CTkLabel(total_frame, text="TỔNG CỘNG:", font=("Inter", 18, "bold")).pack(side="left")
        ...
        self.entry_note = ctk.CTkEntry(note_frame, height=40, corner_radius=7, font=("Inter", 15), placeholder_text="VD: Thu thêm phí vệ sinh, internet...")
        ...
        headers = ["ID", "Mã HĐ", "Phòng", "Khách thuê", "Kỳ thanh toán", "Tổng tiền", "Trạng thái"]
    ...
    def _on_select(self, event):
        ...
        self.entry_elec_prev.configure(state="normal"); self.entry_elec_prev.delete(0, "end"); self.entry_elec_prev.insert(0, str(bill['elec_prev'])); self.entry_elec_prev.configure(state="readonly")
        self.entry_water_prev.configure(state="normal"); self.entry_water_prev.delete(0, "end"); self.entry_water_prev.insert(0, str(bill['water_prev'])); self.entry_water_prev.configure(state="readonly")
        self.entry_room_rent.configure(state="normal"); self.entry_room_rent.delete(0, "end"); self.entry_room_rent.insert(0, format_currency(bill['room_rent_amount'])); self.entry_room_rent.configure(state="readonly")
